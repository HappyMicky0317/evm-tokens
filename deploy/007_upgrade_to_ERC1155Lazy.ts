...
async function main() {
  ...
  console.log(`GhostMarketERC1155V1 > GhostMarketERC1155 upgrade on ${CHAIN} start`);
  ...
  console.log(`GhostMarketERC1155V1 > GhostMarketERC1155 upgrade on ${CHAIN} complete`);
